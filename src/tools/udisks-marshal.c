...
void
udisks_marshal_VOID__BOOLEAN_STRING_UINT_BOOLEAN_DOUBLE (GClosure     *closure,
...
void
udisks_marshal_VOID__BOXED_BOOLEAN_STRING_UINT_BOOLEAN_DOUBLE (GClosure     *closure,
                                                               GValue       *return_value G_GNUC_UNUSED,
                                                               guint         n_param_values,
                                                               const GValue *param_values,
                                                               gpointer      invocation_hint G_GNUC_UNUSED,
                                                               gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__BOXED_BOOLEAN_STRING_UINT_BOOLEAN_DOUBLE) (gpointer     data1,
                                                                               gpointer     arg_1,
                                                                               gboolean     arg_2,
                                                                               gpointer     arg_3,
                                                                               guint        arg_4,
                                                                               ...
                                                                               gdouble      arg_6,
                                                                               gpointer     data2);
  register GMarshalFunc_VOID__BOXED_BOOLEAN_STRING_UINT_BOOLEAN_DOUBLE callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  ...
  callback = (GMarshalFunc_VOID__BOXED_BOOLEAN_STRING_UINT_BOOLEAN_DOUBLE) (marshal_data ? marshal_data : cc->callback);
